...
| 지표 | 무엇을 잡나 | 어떻게 재는가 |
|---|---|---|
| 근거율 | 근거가 달린 문장의 비율 | 문장을 나누고 `«…»` 가 든 문장 수 ÷ 전체 문장 수 |
| 허위 인용 | 코퍼스에 없는 문서를 지어냈는가 | 인용한 문서명이 코퍼스 52건에 있는지 대조 |
| 출처 불일치 | 인용한 문서에 그 내용이 실제로 있는가 | 문장의 고유명사를 **원문에서 문자열 검색** |
| **인용 0곳 절 수** | **전체 평균에 묻히는 절 단위 근거 구멍** | 절마다 인용 개수를 세어 0인 절을 센다 |
| 최다 문서 편중 | 한 문서에만 기대고 있는가 | 가장 많이 인용된 문서의 인용 점유율 |
| 중복률 | 여러 조사관이 같은 문서를 겹쳐 읽었는가 | 두 절 이상이 읽은 문서 수 ÷ 읽은 문서 수 |
| 격리율 | 코디네이터가 혼자 다 읽고 있지 않은가 | 코디네이터가 본 글자 ÷ 팀 전체 글자 |
